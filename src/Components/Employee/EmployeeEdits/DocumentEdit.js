...
// import compose from 'recompose/compose'3
import { withStyles } from '@material-ui/core/styles';
// import MenuItem from '@material-ui/core/MenuItem';
// import TextField from '@material-ui/core/TextField';
...
<br/>
              ...
              <Button
                ...
                type="submit"
                disabled={submitted}
                className={classes.textField1} style={{color:'white',backgroundColor:'#0f0c2b'}}
              >
                {
              ...
              <Button 
              className={classes.textField1} style={{color:'white',backgroundColor:'#0f0c2b'}} onClick={this.props.handleClose} color="primary" autoFocus>
                Cancel
                </Button>
            </ValidatorForm>
